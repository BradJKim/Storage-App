...
# container functions
def create_container(container_name, container_type):
...
def add_value(container_name): # all ints and numbers must be stored as a string for index to be found, ex: 1 vs "1", 
    try:
        container = containers[container_name]
...
def delete_value(container_name):
    try:
        container = containers[container_name]
...
while(1):
    ...
    if(option == 'c'):
        ...
        create_container(container_name=name, container_type=container_type)
    ...
    # check if called to manipulate values but no containers exist
        ...
        delete_container(container_name=container_name)

    elif(option == 'r'):
        container_name = input("Select a container: ")
        get_value(container_name=container_name)
        
    elif(option == 'i'):
        container_name = input("Select a container: ")
        get_index(container_name=container_name)
        
    elif(option == 'a'): 
        container_name = input("Select a container: ")
        add_value(container_name=container_name)

    elif(option == 'd'):
        container_name = input("Select a container: ")
        delete_value(container_name=container_name)
